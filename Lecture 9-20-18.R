...
par(mfrow=c(1,1))
plot(X,Y)
curve(f, from=0, to=2*pi, add=TRUE, col='red')
...
# Using for-loop, obtain k-nearest neighbor estimate when x=
...
# Using for-loop, calculate the bias, variance and MSE this
